      ...
      drawer: Drawer(
        ...
        child: ListView(padding: EdgeInsets.zero, children: <Widget>[ const DrawerHeader(decoration: BoxDecoration(color: Colors.black,),
          ...
          ListTile(
            ...
            title: const Text('隐私政策',style: TextStyle(fontSize: 14,color: Colors.black),),
            onTap: () {
          ...
          ListTile(
            ...
            title: Text('退出登录',style: const TextStyle(fontSize: 14,color: Colors.black),),
            onTap: () {
              prefs.setString(LOCATION_SP_USER_INFO_KEY, "");
              prefs.setString(LOCATION_SP_USER_INFO_ID_KEY, "");
          ...
          ListTile(
            ...
            title: Text('注销账户',style: const TextStyle(fontSize: 14,color: Colors.red),),
            onTap: () {
